...
CountdownTimer::CountdownTimer(const QString &name, AnimationManager& animationManager, QObject *parent) :
    QObject(parent),
    m_name(name),
...
QString CountdownTimer::backgroundAnimation() const {
    return m_animationManager.getAnimationPath(m_backgroundAnimation);
}
void CountdownTimer::setBackgroundAnimation(const QString &backgroundAnimation) {
